        ...
        <div className="bg-slate-50 text-slate-900 font-sans">
            ...
            <header className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6 landing-fade-in">
                        Smart Proxy <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Management</span>
                    </h1>
                    <p className="text-xl md:text-2xl text-slate-600 mb-10 max-w-3xl mx-auto landing-fade-in" style={{ transitionDelay: '100ms' }}>
                        Streamline school operations with intelligent substitution management, automated reporting, and real-time updates.
                    </p>
                    <div className="flex flex-col sm:flex-row justify-center gap-4 landing-fade-in" style={{ transitionDelay: '200ms' }}>
            ...
            <section id="features" className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {/* Feature 1 */}
                        <div className="p-8 rounded-2xl bg-slate-50 border border-slate-100 hover:shadow-lg transition-shadow landing-fade-in">
                        ...
                        {/* Feature 2 */}
                        <div className="p-8 rounded-2xl bg-slate-50 border border-slate-100 hover:shadow-lg transition-shadow landing-fade-in" style={{ transitionDelay: '100ms' }}>
                        ...
                        {/* Feature 3 */}
                        <div className="p-8 rounded-2xl bg-slate-50 border border-slate-100 hover:shadow-lg transition-shadow landing-fade-in" style={{ transitionDelay: '200ms' }}>
            ...
            <section id="download" className="py-20 bg-slate-900 text-white relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto px-4 relative z-10 text-center">
                    <h2 className="text-3xl md:text-4xl font-bold mb-8 landing-fade-in">Get Proxi for Android</h2>
                    <p className="text-lg text-slate-300 mb-10 landing-fade-in">Experience the full power of Proxi on your mobile device. Download the APK directly and install it to get started.</p>

                    <div className="p-8 rounded-3xl bg-white/10 backdrop-blur-md border border-white/20 inline-block landing-fade-in">
